...
import type { RecoveryTrendCard } from "@/lib/health/analytics"
import { transitions } from "@/lib/theme"

export function RecoverySection({ cards }: { cards: RecoveryTrendCard[] }) {
  return (
    <section className="space-y-6">
      <div>
        <SectionLabel>Recovery</SectionLabel>
        <p className="mt-2 max-w-lg text-[15px] leading-relaxed text-muted-foreground">
          Sleep and autonomic trends that show whether you are bouncing back.
        </p>
      </div>
